...
Limits: 50 MiB/file, 1 MiB/line, 256 blocks/record, 4 KiB/visible excerpt, 128 pending command correlations, 100,000 normalized events/session. Discovery stops explicitly after 10,000 entries, depth 16, or 1 GiB of candidate input. A pending-call overflow makes later results unmatched/unknown. Global indexed-event capacity, two-file concurrency, 15-second scheduling, index upserts and preservation of manual links during rebuild belong to T07.

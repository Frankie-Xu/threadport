...
/** Optional capability; absence is observable and must never be rendered as a successful stop. */
export interface ControllableTargetRunner extends TargetRunner { requestStop(input:{vendorSessionId:string|null;runId:string}):Promise<boolean> }
